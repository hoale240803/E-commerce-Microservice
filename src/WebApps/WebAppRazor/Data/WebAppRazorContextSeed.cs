...
{
    public class WebAppRazorContextSeed
    {
        public static async Task SeedAsync(WebAppRazorContext aspnetrunContext, ILoggerFactory loggerFactory, int? retry = 0)
        {
            ...
            catch (Exception exception)
            {
                if (retryForAvailability < 10)
                {
                    ...
                    var log = loggerFactory.CreateLogger<WebAppRazorContextSeed>();
